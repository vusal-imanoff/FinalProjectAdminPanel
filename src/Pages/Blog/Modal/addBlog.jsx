...
function BasicModal({handleCloseAdd,openAdd,setBlogs,handleOpenAdd,setOpenAdd}) {
      ...
      >
        ...
        <Formik
            ...
            onSubmit={(x)=>
            {
                ...
                let url = "http://vusalimanoff-001-site1.htempurl.com/api/admin/Blogs"
            ...
            >
                <Form className='edit-form'>
                    ...
                    <Field className='edit-inp' name='description'/>

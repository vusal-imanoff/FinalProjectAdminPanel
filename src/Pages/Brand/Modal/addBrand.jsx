...
function BasicModal({handleCloseAdd,openAdd,setBrands,handleOpenAdd,setOpenAdd}) {
      ...
      >
        ...
        <Formik
            ...
            onSubmit={(x)=>
            {
                ...
                let url = "http://vusalimanoff-001-site1.htempurl.com/api/admin/Brands"
                ...
                fetch(url, {
                    ...
                    .then(resp => {
                        if (resp.status === 201) {
                            ...
                            axios
                              .get("http://vusalimanoff-001-site1.htempurl.com/api/admin/Brand/getall", {
                                headers: {

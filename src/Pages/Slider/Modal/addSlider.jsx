...
function BasicModal({handleCloseAdd,openAdd,setSlider,handleOpenAdd,setOpenAdd}) {
      ...
      >
        ...
        <Formik
            ...
            onSubmit={(x)=>
            {
                ...
                let url = "http://vusalimanoff-001-site1.htempurl.com/api/admin/Sliders"
            ...
            >
                <Form className='edit-form'>
                    <Field className='edit-inp' name='main' placeholder='main title'/>
                    <Field className='edit-inp' name='sub' placeholder='sub title'/>

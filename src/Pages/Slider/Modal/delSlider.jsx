...
function BasicModal({e,handleClose,open,setSlider,setOpen}) {

    const handleDelete = (x)=>
    {

      let token = JSON.parse(localStorage.getItem("Atoken"));
      axios.delete(`http://vusalimanoff-001-site1.htempurl.com/api/admin/Sliders/${e.id}`,
      {
        headers: {
      ...
      >
        <Box sx={style}>
          <Typography id="modal-modal-title" variant="h6" component="h2">
           Are you sure to permanently delete {e.mainTitle} brand?
          </Typography>

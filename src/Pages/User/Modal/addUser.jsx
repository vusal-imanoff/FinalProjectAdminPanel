...
function BasicModal({handleCloseAdd,openAdd,setUsers,handleOpenAdd,setOpenAdd}) {
      ...
      >
        ...
        <Formik
            ...
            onSubmit={(x)=>
            {
                ...
                let url = "http://vusalimanoff-001-site1.htempurl.com/api/admin/Users/createusers"
